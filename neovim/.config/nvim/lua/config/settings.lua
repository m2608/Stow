...
do
  ...
  local options = {{"termguicolors", true}, {"tabstop", 4}, {"expandtab", true}, {"shiftwidth", 4}, {"relativenumber", true}, {"number", true}, {"signcolumn", "yes"}, {"splitright", true}, {"splitbelow", true}, {"keymap", "russian-jcukenwin2"}, {"iminsert", 0}, {"imsearch", 0}, {"mouse", ""}, {"ignorecase", true}, {"smartcase", true}, {"wrap", true}, {"foldenable", false}, {"completeopt", "menu"}, {"guifont", "APL386 Unicode:h16"}}
...
elseif core.get(vim.g, "GtkGuiLoaded", nil) then
...
vim.diagnostic.config({signs = true, float = {source = "always", border = "single"}, virtual_text = false})
if core.get(vim.g, "GtkGuiLoaded", nil) then
  local hostname = vim.fn.hostname()
  local gui_options = {{"Font", "APL386 Unicode 18"}, {"Option", "Popupmenu", 1}, {"Option", "Tabline", 1}, {"Option", "Cmdline", 1}}
  for _, option in ipairs(gui_options) do
