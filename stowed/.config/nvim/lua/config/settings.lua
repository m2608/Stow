...
do
  ...
  options = {{"termguicolors", false}, {"tabstop", 4}, {"expandtab", true}, {"shiftwidth", 4}, {"relativenumber", true}, {"number", true}, {"signcolumn", "yes"}, {"laststatus", 3}, {"splitright", true}, {"splitbelow", true}, {"keymap", "russian-jcukenwin2"}, {"iminsert", 0}, {"imsearch", 0}, {"mouse", ""}, {"langmap", table.concat(core.map(_3_, lang_mappings), ",")}, {"ignorecase", true}, {"smartcase", true}, {"wrap", true}, {"smoothscroll", true}, {"foldenable", false}, {"completeopt", "menu"}}
