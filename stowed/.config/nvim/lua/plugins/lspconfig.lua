...
local function _5_()
  local servers = {pyright = {}, clojure_lsp = {flags = {completion = {["analysis-type"] = "slow-but-accurate"}}, single_file_support = true}, markdown = {cmd = {"markdown-oxide"}, flags = {debounce_text_changes = 150}, single_file_support = true}, clangd = {}}
